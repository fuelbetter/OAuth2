        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AudienceId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FuelbetterUser", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "FuelbetterUserRoles",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FuelbetterUserRoles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserClaims_FuelbetterUser_UserId",
                        column: x => x.UserId,
                        principalTable: "FuelbetterUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserLogins_FuelbetterUser_UserId",
                        column: x => x.UserId,
                        principalTable: "FuelbetterUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserTokens_FuelbetterUser_UserId",
                        column: x => x.UserId,
                        principalTable: "FuelbetterUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetRoleClaims_FuelbetterUserRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "FuelbetterUserRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_FuelbetterUser_UserId",
                        column: x => x.UserId,
                        principalTable: "FuelbetterUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_FuelbetterUserRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "FuelbetterUserRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
